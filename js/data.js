...
const PRESENTATION_DATA = {
  ...
  slides: [
    ...
    /* 第四章：地獄 (2018-2023 Part 1) */
    {
      ...
      star: {
        s: "【構造的限界】当時の事業では将来（20年後）の成長を実現できる状況になかった危機。<br>【精神的極限】辞めていく仲間とうなされる悪夢、毎夜お酒に逃げる精神的限界の渦中。",
        t: "【極限のコストカット】年商46億円規模から、上場維持費用以外のすべてのコストカットをやり切ること。<br>【再生基盤の構築】東証上場維持を死守し、新たに事業を伸ばせる状態を創出すること。",
        a: "①【身を削る覚悟】役員報酬カットを自ら断行し、コスト削減をリード。<br>②【事業再編】将来性のない既存事業の撤退・再編を完遂。<br>③【誠実な対話】社員や関係者と逃げずに向き合う対話により全社改革を実行。",
        r: '2021年10月、<span class="stat-callout text-highlight-purple">月売上500万・月赤字2800万までコスト圧縮</span>を完了。<span class="text-highlight-purple">東証上場維持</span>を完遂し、新たな事業を伸ばせる状態を作り上げた。'
      },
      why: {
        title: "Why : 弱さを知る者の覚悟",
