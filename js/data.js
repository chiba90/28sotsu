 ...
 * Storytelling Edition: Engaging, high-impact narrative for career briefing.
 */
const PRESENTATION_DATA = {
  ...
  slides: [
    /* SLIDE 1: INTRO */
    {
      ...
      subtitle: '筑波大学新卒入社から13年。天国と地獄のすべてを現場でくぐり抜けた当事者が語る「リアルな生存戦略」。',
      presenter: {
        name: "千葉 博文",
      ...
      cards: [
        {
          ...
          body: "仕事を選べない環境にある地方の現実に立ち向かう。挑戦を後押しし、若者から自立した起業家が生まれる<strong>持続可能な事業生態系を全国に創り出すこと</strong>が、私の人生をかけたミッションです。"
        },
        {
          badge: "ORIGIN : 2011年 震災ボランティア",
          badgeColor: "blue",
          title: "「この街が綺麗になる頃には、もう誰も住んでいないだろうね」",
          body: "被災地のお婆さんの一言に言葉を失った。<strong>「真の復興とは支援ではなく、この場所でお金を稼ぎ使える仕組み＝仕事の創出である」</strong>と確信。リアルワールドへ新卒入社しました。"
        }
      ],
      ...
      cards: [
        {
          ...
          body: "慣れ親しんだ思考の枠組みを脱ぎ捨て、常に自らの既成概念を<span class=\"text-highlight-amber\">アンラーン（学習棄却）</span>し続けます。"
        },
        {
        ...
        },
        {
          ...
          body: "将来、地方で挑戦者を支援し資金と人を動かすため、<span class=\"text-highlight-purple\">誰もが認める信用価値</span>を高めます。"
        }
      ],
    ...
    /* SLIDE 4: W-STAR 2013-2018 */
    {
      ...
      star: {
        s: "主力ポイントサイト「げん玉」の責任者に就任も、急激なスマホシフトに対し獲得投資資金ゼロの極限状態。",
        t: "追加資金ゼロの制約下で、競合を上回る自律的で強力な「新規収益エンジン」を立ち上げること。",
        a: "アドテク融合の「ポイントゲーム」を自社開発し、競合メディア群へもOEM展開（B2B2C）するプラットフォーム戦略を実行。",
        r: '<span class="stat-callout text-highlight-blue">年間4億円の新規営業利益</span>を創出し、子会社代表取締役社長に就任。'
      },
      why: {
        title: "W : Why (当事者意識の覚悟)",
        body: "新卒時にやりたかった部署ではなかったが、「自身の事業が会社全体の投資源泉である」と解釈を転換。置かれた場所で圧倒的な結果を出し、自ら存在意義を創出しました。"
      },
    ...
    /* SLIDE 5: W-STAR 2018-2023 (1) */
    {
      ...
      star: {
        s: "主力事業の急減速により抜本ピボットを決断。年商46億円から<span class=\"text-highlight-rose\">月商500万円（99%減）</span>まで一時縮小する極限状態。",
        t: "倒産リスクを完璧に回避し、東証マザーズ（現グロース）における「上場維持」条件をクリアすること。",
        a: "役員報酬30%カットを即座に断行。不採算事業の売却と、社員一人ひとりと誠意を持った対話による構造改革を主導。",
        r: '<span class="stat-callout text-highlight-purple">不可能と言われた「上場維持」を完遂</span>。次の挑戦のための筋肉質な財務基盤を守り抜く。'
      },
      why: {
        title: "W : Why (不退転の意志)",
        body: "過去の成功も自身が作った子会社も全て失う中で、「自分が選択した場所で最後まで戦い抜く」と決意。ダメになるなら極限までやり切るという責任と誇りを貫きました。"
      },
    ...
    /* SLIDE 6: W-STAR 2018-2023 (2) */
    {
      ...
      star: {
        s: "新事業補強のためWebメディアM&Aを企画も仲介手数料の予算なし。直後に主要Googleアルゴリズム大被弾（利益90%減）。",
      ...
      why: {
        ...
        body: "「自分が利益の太い柱を作らなければ、新事業（デジタルギフト®）が育つ前に会社が倒れる」。言い訳を一切捨て、自らの行動量と分析力で切り開きました。"
      },
    ...
    /* SLIDE 7: W-STAR 2023-PRESENT */
    {
      ...
      star: {
        ...
        a: "ABMマーケティング主導。採用では取締役自らがトップリクルーターとして最前線に立ち、経営のリアルを100%オープンに対話。",
        r: 'GMVを45億円から<span class="stat-callout text-highlight-emerald">300億円規模（6.6倍）</span>へ拡大。27卒内定承諾5名獲得。正社員数1.5倍。'
      },
      why: {
    ...
    /* SLIDE 8: TRUTH 1 */
    {
      ...
      fact: {
        ...
        body: "多くの場合、人員不足による<span class=\"text-highlight-rose\">「作業の丸投げ（自由度）」</span>に過ぎません。<br><br>本当の裁量権（事業を動かす・予算を決める権限）とは、<strong>「成果」と「信頼残高」</strong>をもぎ取ったプロにのみ与えられる報酬です。成果を出したメンバーには最高の打席を用意します。"
      },
    ...
    /* SLIDE 9: TRUTH 2 */
    {
      ...
      myth: {
        ...
        body: "従来の終身雇用モデルは崩壊。これからはサークルではなく、成果にコミットする<strong>Netflix型「高密度プロスポーツチーム」</strong>へ移行します。"
      },
      fact: {
        label: "真の「安定」の再定義",
      ...
      cards: [
        {
          ...
          body: "「事業再生時の離職率は？」「退職勧奨時どう声をかけた？」「取締役の今のぶっちゃけた給与や評価制度は？」など、どんなタブー質問でも直球回答します。",
