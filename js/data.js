  ...
  slides: [
    ...
    /* 第二章：原点 (2011 Tohoku Origin) */
    {
      ...
      cards: [
        ...
        {
          badge: "STORY 02 : クラウドソーシングとの出会い",
          badgeColor: "amber",
          title: "クラウドソーシングの可能性に賭け、第一志望で入社",
          lead: "場所にとらわれず働ける仕組みを求めて。",
          body: "「ネット上で仕事を作る」模索の中で<strong>クラウドソーシングの存在</strong>を知る。これこそが日本中の課題を解決する手段だと直感し、<strong>デジタルプラス（旧リアルワールド）を第一志望として就職活動を実施</strong>、覚悟の入社を果たしました。",
          footer: "💡 DECISION : クラウドソーシングの未来を信じ第一志望入社"
        }
      ],
    ...
    /* 第四章：地獄 (2018-2023 Part 1) */
    {
      ...
      star: {
        s: "【構造的限界】当時の事業では将来（20年後）の成長を実現できる状況になかった限界。<br>【経営危機】年商46億円規模から急降下し、会社崩壊・倒産目前の危機的背景。",
        t: "【極限のコストカット】年商46億円規模から、上場維持費用以外のすべてのコストカットをやり切ること。<br>【再生基盤の構築】東証上場維持を死守し、新たに事業を伸ばせる状態を創出すること。",
        a: "①【身を削る覚悟】役員報酬カットを自ら断行し、全社コスト削減を率先。<br>②【事業再編】将来性のない既存事業の撤退・再編を完遂。<br>③【誠実な対話】社員や関係者と逃げずに向き合う対話により全社改革を実行。",
        r: '📌 2021年10月、<span class="stat-callout text-highlight-purple">月売上500万・月赤字2800万までコスト圧縮</span>を完了。<span class="text-highlight-purple">東証上場維持</span>を完遂し、新事業を伸ばせる状態を創出。<br>🍶 仲間の離脱や重圧から「毎夜悪夢・お酒に逃げる精神的極限状態」を経験するも、それを乗り越えて<b>「逃げずに守り抜く当事者の覚悟」</b>を獲得。'
      },
      why: {
        title: "Why : 弱さを知る者の覚悟",
