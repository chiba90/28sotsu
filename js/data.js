 ...
 * Cleaned punctuation and markdown tags.
 */
  ...
  slides: [
    /* SLIDE 1: INTRO */
    {
      ...
      presenter: {
        ...
        daughterNote: "👧 愛娘に誇れる圧倒的に明るい未来をつくることが、すべての原動力！",
      ...
      cards: [
        {
          ...
          body: "単なる雇用支援に留まらず、挑戦を後押しし自立した起業家が生まれる<strong>事業生態系を全国に創り出すこと</strong>が、私の人生をかけたミッションです。"
        },
        {
          badge: "ORIGIN : 2011年 震災ボランティア",
          badgeColor: "blue",
          title: "「この街が綺麗になる頃には、もう誰も住んでいないだろうね」",
          body: "被災地のお婆さんの一言に衝撃を受け、<strong>「真の復興とは支援ではなく、持続的にお金を稼ぎ使える仕組み＝仕事の創出である」</strong>と確信。新卒入社へ。"
        }
      ],
    ...
    /* SLIDE 8: TRUTH 1 */
    {
      ...
      fact: {
        ...
        body: "多くの場合、人員不足による<span class=\"text-highlight-rose\">「作業の丸投げ（自由度）」</span>に過ぎません。<br><br>本当の裁量権とは、<strong>「成果」と「信頼残高」</strong>をもぎ取ったプロにのみ与えられる報酬です。成果を出したメンバーには最高の打席を用意します。"
      },
